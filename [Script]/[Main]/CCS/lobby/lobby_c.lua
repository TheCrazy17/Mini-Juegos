...
Login.weekdays = {"Domingo", "Lunes", "Martes", "Miercoles", "Jueves", "Viernes", "Sabado"}
...
Login.lobby.rows = {{tag = "Battle Royale", name = "Battle Royale", index = 1},{tag = "PVP", name = "PVP", index = 1},{tag = "Race", name = "Race", index = 1}, {tag = "Fun", name = "Fun", index = 1}, {tag = "Custom", name = "Custom Arenas", index = 1, creatable = true}, {tag = "Clan", name = "Clan Arenas", index = 1, creatable = true}, {tag = "Competitive", name = "Competitive", index = 1}, {tag = "Misc", name = "Misc", index = 1}}
Login.lobby.entries = {}
...
addEventHandler("onClientChallengeInfo", root, Login.challenge)		]] -- La zona servidor y cliente dependen de un recurso inexsistente
...
-- Faltan recursos por lo cual el Competitive queda desabilitado tira muchos triggers
