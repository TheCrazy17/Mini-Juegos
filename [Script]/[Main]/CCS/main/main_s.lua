...
function Main.start()
	...
	local gg = Arena.new("gungame", "Gungame", "PVP", "PVP", "gungame", 32, false, "Voting", "#679E37", 60000, true, "Server", true, false)
	gg:setPodiumEnabled(true)
	gg:setChallengesEnabled(true)
	gg:setGamblingEnabled(true)
	gg:setUserpanelEnabled(true)
	gg:setSpectatorsEnabled(false)
	gg:setAFKCheckEnabled(false)
	gg:setPingCheckEnabled(true)
	gg:setFPSCheckEnabled(false)
	gg:setVoteredoEnabled(true)
	gg:setTopkillsEnabled(true)
	gg:setStatsEnabled(true)
	gg:setMapstatsEnabled(true)
	...
	local hay = Arena.new("Hay", "Hay", "Hay", "Fun", "Hay", 128, false, "Manual", "#4CAF50", 900000, true, "Server", true, false)
	hay:setSpectatorsEnabled(true)
	hay:setModsEnabled(true)
	hay:setStatsEnabled(true)
	...
	local Gungame = Arena.new("GunGame", "GunGame", "GunGame", "GunGame", "GunGame", 32, false, "Las Venturas", "#FF7F50", 1200000, true, "Server", true, false)
